...
export const getAllEcosystem = asyncHandler(async (req: Request, res: Response) => {
...
export const getEcosystemById = asyncHandler(async (req: Request, res: Response) => {
...
export const createEcosystem= asyncHandler(async (req: Request, res: Response) => {
    const userId = req.user?.userId;
...
export const updateEcosystem = asyncHandler(async (req: Request, res: Response) => {
  const {
    title,
    description,
    projectType,
...
export const deleteEcosystem = asyncHandler(async (req: Request, res: Response) => {
