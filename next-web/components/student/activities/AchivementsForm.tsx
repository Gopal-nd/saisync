...
import { useAchivement, useAchivements, useCreateAchivement, useUpdateAchivement } from "@/hooks/useAchivements";
  ...
  if (isView) {
    return (
      <div className="max-w-xl mx-auto p-6 rounded shadow ">
        <h2 className="text-2xl font-semibold mb-4">Achivements  Details</h2>
  ...
  return (
    <div className="max-w-xl mx-auto p-4 rounded shadow ">
      <h2 className="text-xl font-bold mb-4">
        {isEdit ? "Edit" : "Create"} Achivements
      </h2>
