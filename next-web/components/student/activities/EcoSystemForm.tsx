...
import { useCreatEcosystem, useEcosystem, useEcosystems, useUpdateEcosystem } from "@/hooks/useEcoSystem";

export default function EcoSystemForm({ isEdit = false, isView = false }: { isEdit?: boolean, isView?: boolean }) {
  const { id } = useParams();
